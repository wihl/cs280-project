...
%4) I'd like to add one sentence to the part about releasing subgoals

%5) NEW: Fix the bibliography - there are a bunch of orphaned references that appear at the end but can't be found in the text

%6) Resolve a few open questions in my music analysis section

%7) Limitations, Generalizations. See comment
