...
\item Do composers that feel that communication through metadata Sub-goals was efficient for collaborating on blocks of music?
...
To address the first point xxxxxxx. To address the second point xxxxxxxxxxxxx.

% subgoal communication versus email
% 
...
%4) Resolve a few open questions in my music analysis section
...
%5) review orphaned references that appear at the end of tex but not mentioned in text. From Mark: this point is mainly for me, but I wanted to get this out of my TODOs having to do with actual content edits
