...
\begin{description}
\item [CreatePlan] - create a SharedPlan that includes intentionality and other metadata.
\item [Evaluate] - prior to committing a revision, perform an analysis of the current score against intentionality.
\item [CreateSubplan] - create a sub-plan, specifying the inter-composer communication.
\item [EditSubplan] - revise an existing sub-plan
