...
\textit{Model may not generalize.} While we are confident that SharedPlans, software revision control and algorithmic evaluation is applicable to music composition, it is uncertain that the overall framework can be generalized to other domains. Version control on visual artwork seems promising and helpful, but simple text-based revision may not support the editing rich-enough digital representations in an intuitive or useful way. Algorithmic evaluation of intent-matching may be more difficult to design for a painting. Music theory has a historically long interplay with mathematical analysis, and aspects of musical form are experienced generically at the level of experiencing the form of a story, movie, or play. The static experience of a painting is less related. To this end, more generalizable techniques of automated analysis are necessary [TODO: See Deep Learning DIscussion in Section Future Work].


%\todo[inline]{Mark} DO NOT DELETE
...
%2) Music analysis section: resolve two open questions, and mention multivariate info theory (get rid of Cohen quotes comment)

%3) multiple composers use case

%4) review orphaned references that appear at the end of tex but not mentioned in text

%5) Resolve a few open questions in my music analysis section

%6) Limitations, Generalizations. See comment

%7) David Greenberg's point about Spotify and EchoNest.
...
%%%%% RESOLVE THESE REFERENCES (NOT PRESENT IN PAPER) %%%%%%%%

\section*{Not References}

\todo[inline]{Orphaned references - not found in text}
