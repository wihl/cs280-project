...
In the manifesto, Widner recalls key points made by Cohen in the 1950s, that an information theory approach for describing music must expand in two uncovered territories: 1) there must be a theory of intearctions for multiple streams of musical information, for example for the way in which rhythmic information may make harmonic events more or less certain. Composers do not decide all of music's parameters separately. 2) there must be theory for account for multiple levels of structural hierarchy coming at once from a stream of musical information. Rhythms constitute a local time feel but also accelerate a piece toward new sections.

Recently explored challenges in information theory may provide ways to explore these important qualities of music. These include the generalization of mutual information to several variables. Multivariate mutual information is used to describe the extent to which the knowledge of one event can reduce the entropy in several other variables [V.d. Cruys 2011]. 
